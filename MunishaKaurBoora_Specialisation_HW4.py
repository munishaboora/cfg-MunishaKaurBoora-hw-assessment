...
- I've used the search_in_matrix function provided as a template for my code.
- Within the function, I've created a for loop and used the enumerate function with the for loop to obtain a counter with each element of the list. 
   - In this case, the counter is the index number of each element in the list stored in the variable matrix.
- I've then used an if statement to determine whether or not the target number is within each element, each sublist, of the overall list stored within the matrix variable.  
